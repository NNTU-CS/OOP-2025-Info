...
Пояснительная записка оформляется в виде единого PDF-файла. Имя файла должно строго соответствовать значению "Имя файла" из таблицы, расположенной в репозитории **OOP-2025**.
